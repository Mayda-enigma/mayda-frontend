...
allowed-tools: Bash(gh:*), Bash(git:*), Bash(jq:*), Bash(npm:*), Bash(pnpm:*), Bash(yarn:*), Bash(node:*), Bash(npx:*), Bash(python:*), Bash(python3:*), Bash(pip:*), Bash(poetry:*), Bash(uv:*), Bash(pytest:*), Bash(ruff:*), Read, Edit, Write, Glob, Grep
---
