...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-xs font-bold uppercase tracking-wider leading-none transition-all duration-[var(--duration-fast)] ease-[var(--ease-out)] [&_svg]:pointer-events-none [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive relative before:absolute before:-inset-2 before:content-['']",
  {
    variants: {
      variant: {
        default:
      ...
      size: {
        default: 'px-3 py-1.5 [&_svg]:size-3.5',
