...
export function NotificationSystem({ onNotificationUpdate }: NotificationSystemProps) {
 ...
 case "urgent":
 return "border-primary/20 bg-primary/5 dark:border-primary/80 dark:bg-primary/5/20"
 case "assistance":
 ...
 <p className="text-xs text-success/70 dark:text-success/20 line-clamp-1">{notification.message}</p>
 </div>
 </div>
 </CardContent>
 </Card>
