...
export function TableStatusBar({ tables }: TableStatusBarProps) {
 ...
 <div className="text-xs text-muted-foreground font-medium font-sans">Free</div>
 </div>
 <div className="text-center">
 <div className="text-sm font-semibold text-blue-600 font-sans">
 {tables.filter((t) => t.status === "occupied").length}
 </div>
 <div className="text-xs text-muted-foreground font-medium font-sans">Occupied</div>
 </div>
 <div className="text-center">
 <div className="text-sm font-semibold text-primary font-sans">
 {tables.filter((t) => t.status === "waiting").length}
 </div>
 <div className="text-xs text-muted-foreground font-medium font-sans">Waiting</div>
 </div>
 <div className="text-center">
 <div className="text-sm font-semibold text-emerald-600 font-sans">
 {tables.filter((t) => t.status === "served").length}
 </div>
 <div className="text-xs text-muted-foreground font-medium font-sans">Served</div>
 </div>
 </div>
 </div>
 </div>
