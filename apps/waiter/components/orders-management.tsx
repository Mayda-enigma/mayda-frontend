...
export function OrdersManagement() {
 ...
 <Button
 size="sm"
 className=" hover:-dark text-white h-9 px-3 text-sm"
 >
 ...
 order.priority === "high" && order.status !== "served" && "ring-1 ring-primary/30",
 )}
 >
 ...
 {order.priority === "high" && <AlertTriangle className="h-3 w-3 sm:h-4 sm:w-4 text-primary" />}
 </div>
