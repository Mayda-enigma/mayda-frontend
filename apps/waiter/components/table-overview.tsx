...
const statusConfig = {
 ...
 cardColor: "border-primary/20 dark:border-primary/80",
 },
 served: {
 label: "Served",
...
export function TableOverview() {
 ...
 {table.needsAttention && <AlertTriangle className="h-2.5 w-2.5 sm:h-3 sm:w-3 text-primary" />}
 {Math.random() > 0.7 && (
 ...
 <Button
 size="sm"
 className=" hover:-dark text-white text-xs h-6 px-2"
 >
