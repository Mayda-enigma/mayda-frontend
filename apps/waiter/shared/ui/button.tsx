  ...
  ].join(' '),
  {
    variants: {
      variant: {
        ...
        destructive: 'bg-destructive text-white border border-destructive/30 shadow-depth-btn hover:bg-destructive/95 active:shadow-depth-btn-active focus-visible:ring-destructive/20 dark:focus-visible:ring-destructive/40 dark:bg-destructive/70',
