    ...
    <Card className="overflow-hidden border-blue-200 bg-gradient-to-r from-blue-50 to-purple-50 mb-4">
      <CardContent className="p-4">
        <div className="flex items-center justify-between mb-3">
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-sm text-blue-700">Menu Iftar spécial disponible</p>
            </div>
          </div>
          <Button
            variant="ghost"
        ...
        <div className="bg-white/70 rounded-lg p-3 mb-3">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm font-medium text-blue-900">Iftar du jour</span>
            </div>
        ...
        <p className="text-xs text-blue-600 text-center mt-2">
          ...
          Prix et horaires spéciaux pour l'Iftar
        </p>
      </CardContent>
    </Card>
  )
